...
public class RegistrationFormBinder {
    ...
    public RegistrationFormBinder(@Autowired UserService userService) {
    ...
    public void addBindingAndValidation() {
        BeanValidationBinder<NewUserInfo> binder = new BeanValidationBinder<>(NewUserInfo.class);
        ...
        registrationForm.getSubmitButton().addClickListener(event -> {
            try {
                ...
                NewUserInfo userBean = new NewUserInfo();
     ...
     */
    private void showSuccess(NewUserInfo userBean) {
